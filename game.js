...
$('#randomize-player').onclick=()=>{$('[name=givenName]').value=randomFrom(maleVictorianNames);$('[name=familyName]').value=randomFrom(victorianSurnames)};
$('#randomize-partner').onclick=()=>{$('[name=partnerName]').value=randomFrom(femaleVictorianNames)};
